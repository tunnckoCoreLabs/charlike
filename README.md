...
- [charlike-cli](https://www.npmjs.com/package/charlike-cli): Small CLI layer for the [charlike][] project scaffolder, requires charlike@^1.7 | [homepage](https://github.com/tunnckoCoreLabs/charlike-cli "Small CLI layer for the [charlike][] project scaffolder, requires charlike@^1.7")
