...
Use the [`docs` label](https://github.com/#{owner}/#{name}/labels/docs) to find suggestions for what we'd love to see more documentation on.
...
We're always looking for more opinions on discussions in the issue tracker. It's a good opportunity to influence the future direction of `#{name}`.

The [`question` label](https://github.com/#{owner}/#{name}/labels/question%20%2F%20discussion) is a good place to find ongoing discussions.
