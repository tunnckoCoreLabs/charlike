# Contributing to charlike

:sparkles: Thanks for your contribution in advance! :tada:

First and foremost, thank you! We appreciate that you want to contribute to `charlike`, your time is valuable, and your contributions mean a lot to us.
...
As a user of `charlike` you're the perfect candidate to help us improve our documentation. Typo corrections, error fixes, better explanations, more examples, etc. Open issues for things that could be improved. Anything. Even improvements to this document.

Use the [`docs` label](https://github.com/tunnckoCore/charlike/labels/docs) to find suggestions for what we'd love to see more documentation on.
...
We're always looking for more opinions on discussions in the issue tracker. It's a good opportunity to influence the future direction of `charlike`.

The [`question` label](https://github.com/tunnckoCore/charlike/labels/question%20%2F%20discussion) is a good place to find ongoing discussions.
...
1. **version**: what version of `charlike` were you using when you experienced the bug?
